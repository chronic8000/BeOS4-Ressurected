#include "../../../headers/interface/Control.h"
#include "Message_patched.h"
#include <Application.h>
#include <unistd.h>
#include <stdio.h>
#include <stdlib.h>

#include "termwindow_patched.h"
#include "shell.h"
		   ...
		   B_NOT_RESIZABLE | B_NOT_ZOOMABLE )
{
	...
	if(fd >= 0){
		tv->SetFD(fd);
		resume_th::read(spawn_th::read(bTermWindow::reader,"pty reader",B_NORMAL_PRIORITY,this));
	}
