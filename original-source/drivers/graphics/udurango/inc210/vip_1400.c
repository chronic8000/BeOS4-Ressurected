...
int sc1400_set_vip_enable(int enable)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_set_vip_base(unsigned long even, unsigned long odd)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_set_vip_pitch(unsigned long pitch)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_set_vbi_enable(int enable)
#else
...
#endif
{
	unsigned long value;
	value = READ_VIP32(SC1400_VIP_CONTROL);
	if (enable) value |= SC1400_VIP_VBI_CAPTURE_EN;
	else value &= ~SC1400_VIP_VBI_CAPTURE_EN;
	WRITE_VIP32(SC1400_VIP_CONTROL, value);  
	return(0);
}
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_set_vbi_base(unsigned long even, unsigned long odd)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_set_vbi_pitch(unsigned long pitch)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_get_vip_enable(void)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
unsigned long sc1400_get_vip_base(int odd)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
unsigned long sc1400_get_vip_pitch(void)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
int sc1400_get_vbi_enable(void)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
unsigned long sc1400_get_vbi_base(int odd)
#else
 ...
 */
#if GFX_VIDEO_DYNAMIC
unsigned long sc1400_get_vbi_pitch(void)
#else
