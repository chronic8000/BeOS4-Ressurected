...
init_debug (void)
{
	add_debugger_command ("nvdump",
			      nvdump,
			      "nvdump - dump nvidia kernel driver data");
...
uninit_debug (void)
{
	...
	remove_debugger_command ("nvdump", nvdump);
}
