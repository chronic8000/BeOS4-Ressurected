...
{
    {0x000001AA, 0x00005555}
};
static unsigned nv3TablePGRAPH_15BPP[][2] =
{
    {0x000001AA, 0x00006666}
};
static unsigned nv3TablePGRAPH_16BPP[][2] =	/*  <ewhac>	*/
{
    {0x000001AA, 0x00004444}
};						/*  </ewhac>	*/
static unsigned nv3TablePGRAPH_32BPP[][2] =
{
    {0x000001AA, 0x00007777}
};
...
static unsigned nv3TablePRAMIN_16BPP[][2] =	/*  <ewhac>	*/
{
    /*           0xXXXXX2XX For  MSB mono format */
    /*           0xXXXXX3XX For  LSB mono format */
    {0x00000D04, 0x10110204},
    {0x00000D08, 0x10110204},
    {0x00000D0C, 0x1011020C},
    {0x00000D10, 0x10118204},
    {0x00000D14, 0x10110204},
    {0x00000D18, 0x10110204},
    {0x00000D1C, 0x10419208},
    {0x00000D30, 0x10118204}
};						/*  </ewhac>	*/
