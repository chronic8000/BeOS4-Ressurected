 ...
 *
 * Definitions private to Intel 8255x EtherExpress ethernet driver
 *
 * Modification History (most recent first):
 *
 * 04 Sept 98	RHS	new today
 */
...
//#if __INTEL__
#define outb(value, port)		(*pci->write_io_8)	(port, (value))
#define inb(port)				(*pci->read_io_8)	(port)
#define outw(value, port) 		(*pci->write_io_16)	(port , (value))
#define inw(port)				(*pci->read_io_16)	(port)
#define outl(value, port) 		(*pci->write_io_32)	(port , (value))
#define inl(port)				(*pci->read_io_32)	(port)
