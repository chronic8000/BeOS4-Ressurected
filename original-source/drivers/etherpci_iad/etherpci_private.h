...
#if __INTEL__
#define ether_outb(data, regno, byte)	(*pci->write_io_8)(data->port + (regno), (byte))
#define ether_inb(data, regno)			(*pci->read_io_8)(data->port + (regno))
#define ether_outw(data, regno, word) 	(*pci->write_io_16)(data->port + (regno), (word))
#define ether_inw(data, regno)			(*pci->read_io_16)(data->port + (regno))
#else
#define ether_outb ppc_ether_outb
#define ether_inb ppc_ether_inb
#define ether_outw ppc_ether_outw
#define ether_inw ppc_ether_inw
#endif
