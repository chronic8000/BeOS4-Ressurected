...
/*
 * $Log:   V:/Flite/archives/FLite/src/FLFLASH.H_V  $
   
      Rev 1.13   Jan 13 2000 18:19:16   vadimk
   TrueFFS OSAK 4.1
 *
 *     Rev 1.12   15 Nov 1999 15:25:42   dimitrys
 *   Add 512 Mbit Toshiba and Samsung flash support
 *       (big address type - 4 byte address cycle)
 *
 *     Rev 1.11   03 Feb 1999 18:18:10   marina
...
struct tFlash {
  ...
  char      mediaType;      /* DOC / MDOC / NOT_DOC */
