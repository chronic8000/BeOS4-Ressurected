/*
 * $Log:   V:/Flite/archives/FLite/src/FLREQ.H_V  $
   
      Rev 1.1   Jan 13 2000 18:21:06   vadimk
   TrueFFS OSAK 4.1

      Rev 1.0   22 Dec 1998 14:05:20   marina
   Initial revision.
 *
 */
...
typedef struct {
  ...
  long		irLength;	/* No. of bytes, size or position for   */
				/* operation			 	*/
#if defined(ABS_READ_WRITE) || defined(LOW_LEVEL)
