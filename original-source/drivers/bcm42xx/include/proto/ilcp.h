 ...
 *
 * $Id: ilcp.h,v 9.46 2000/05/01 23:56:14 henryp Exp $
 */
...
(parq->arq_seq.seq16 = hton16((uint16)(((rseq) & ARQ_SEQ_MASK) | (ntoh16((uint16)parq->arq_seq.seq16) & ~ARQ_SEQ_MASK))))

#define ARQ_GETRSV(seq) ((ntoh16((seq)) >> ARQ_RSV_SHIFT) & (ARQ_RSV_MASK >> ARQ_RSV_SHIFT))
#define ARQ_SETRSV(lrsv, rrsv) \
(lrsv = hton16((uint16)((((rrsv) << ARQ_RSV_SHIFT) & ARQ_RSV_MASK) | (ntoh16((uint16)lrsv) & ~ARQ_RSV_MASK))))
...
#define CERT_TO_MSEC				64000 /* 1 msec */
...
/* Command Segment IDs */
#define CDCF_V0_CSTYPE_NULL			0	/* no data in this segment */
#define CDCF_V0_CSLEN_NULL			4
#define CDCF_V0_CSTYPE_ERROR		1	/* error code */
#define CDCF_V0_CSLEN_ERROR			4
#define CDCF_V0_CSTYPE_INFOREPLY	2	/* frame contains reply to dump
											request */
#define CDCF_V0_CSLEN_INFOREPLY		2
#define CDCF_V0_CSTYPE_TEXT			3	/* ASCII text - variable len */
#define CDCF_V0_CSTYPE_DATA			4	/* test data - variable len */

#define CDCF_V0_CSTYPE_REFSEQ		5


#define CDCF_V0_CSTYPE_TXPE			16
#define CDCF_V0_CSTYPE_TXPRI		17
#define CDCF_V0_CSTYPE_LINKINT		18
#define CDCF_V0_CSTYPE_TXDOWN		19
#define CDCF_V0_CSTYPE_TXINHIBIT	20
#define CDCF_V0_CSTYPE_TXUP			21
#define CDCF_V0_CSTYPE_HPNAMODE		22

/* required if node supports LARQ */
#define CDCF_V0_CSTYPE_LARQ			32
/* required if node supports CSA */
#define CDCF_V0_CSTYPE_CSA			33
#define CDCF_V0_CSTYPE_CSAHPNAMODE	34

#define CDCF_V0_CSTYPE_VENDOR		64

#define CDCF_V0_CSTYPE_SA			129
#define CDCF_V0_CSLEN_SA			6
#define CDCF_V0_CSTYPE_NUM_DA		130
#define CDCF_V0_CSLEN_NUM_DA		1
#define CDCF_V0_CSTYPE_DA			131
#define CDCF_V0_CSLEN_DA			6
#define CDCF_V0_CSTYPE_DGEN_TYPE	132
#define CDCF_V0_CSTYPE_DGEN_DATA	133
#define CDCF_V0_CSTYPE_LENGTH		134
#define CDCF_V0_CSTYPE_NPKTS		135
#define CDCF_V0_CSTYPE_BURST_INT	136
#define CDCF_V0_CSTYPE_BURST_NPKTS	137
#define CDCF_V0_CSTYPE_NUMACKS		138
#define CDCF_V0_CSTYPE_TGEN_TYPE	139
#define CDCF_V0_CSTYPE_TGEN_DATA	140
#define CDCF_V0_CSTYPE_DATA_XSUM	141
#define CDCF_V0_CSTYPE_TAG_XSUM		142

#define CDCF_V0_CSTYPE_XMTFRAMES	257	/* total xmt frames w/o err */
#define CDCF_V0_CSTYPE_XMTBYTES		258	/* total xmt bytes w/o err */
#define CDCF_V0_CSTYPE_XMTERR		259	/* transmit errors */
#define CDCF_V0_CSTYPE_XMTETIME		260	/* elapsed time from xmt of first frame
											to xmt of first 'end' frame */

#define CDCF_V0_CSTYPE_RCVFRAMES	261	/* total rcv frames w/o err */
#define CDCF_V0_CSTYPE_RCVBYTES		262	/* total rcv bytes w/o */
#define CDCF_V0_CSTYPE_RCVSEQMISS	263	/* missed seq */
#define CDCF_V0_CSTYPE_RCVSEQERR	264	/* rcv seq out of order */
#define CDCF_V0_CSTYPE_RCVDATAERR	265	/* rcv data compare error */
#define CDCF_V0_CSTYPE_RCVERR		266	/* any other errors */
#define CDCF_V0_CSTYPE_RCVETIME		267	/* elapsed time from recv of first frame
											to recv of first 'end' frame */
#define CDCF_V0_CSTYPE_RCVXSUMERR	268	/* rcv checksum error */

#define CDCF_V0_CSTYPE_SETMSGLEVEL	1025	/* set debug message level */
...
#define CDCF_V0_ERR_UNSUP_TGEN		6	/* unsupported tag generator */
