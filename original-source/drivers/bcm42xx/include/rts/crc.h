...
*/
/*******************************************************************************
 * $Id: crc.h,v 8.7 1999/11/09 18:41:28 gmo Exp $
...
void   hcs(uint8 *, uint32);
uint8  crc8(uint8 *, uint32, uint8);
uint16 crc16(uint8 *, uint32, uint16);
uint32 crc32(uint8 *, uint32, uint32);
