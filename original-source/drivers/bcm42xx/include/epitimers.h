 ...
 */
#define LATER_THAN(now, timer) ((timer != NO_TIMER) && ((((_ststamp_t)timer - (_ststamp_t)now) & TIMER_WRAP_MASK) != 0))
 ...
 * First arg should not be NO_TIMER.
 */
#define EARLIER_THAN(new, timer) ((timer == NO_TIMER) || ((((_ststamp_t)new - (_ststamp_t)timer) & TIMER_WRAP_MASK) != 0))
