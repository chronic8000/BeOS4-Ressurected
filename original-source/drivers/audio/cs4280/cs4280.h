...
// configuration space of the CS4620 part.
//
//****************************************************************************
...
//****************************************************************************
//
// The following define the offsets of addresses relative to BA1
// for the CS4620.  From Chris's  HWDEFS.H
//****************************************************************************
              // Playback registers.
#define GOF_PER_SEC                                200
#define PROC_SRC_SCB                              0xa0

#define BA1_PLAY_DCW                              0xc0
#define BA1_PFIE                                  0xc4
#define PFIE_MONO                                 0x00002000
#define PFIE_8BIT                                 0x00009000
#define PFIE_INT_DISABLE                          0x00000010

#define BA1_PLAY_BUFFER_ADDRESS                   0xc8
#define BA1_PLAYBACK_VOLUME                       0xf8
#define BA1_CAPTURE_BUFFER_ADDRESS                0x10c
#define BA1_WRITE_BACK_CHILD_REG                  0x124
#define BA1_MASTER_MIX_CHILD_REG                  0x264
#define BA1_PLAY_SAMPLE_RATE_CORRECTION_REG       0x288
#define BA1_STARTSTOP_PLAY                        0x2a4
#define BA1_PLAY_PHASE_INCREMENT_REG              0x2b4

              // Capture Registers.
#define BA1_VARIDEC_BUF_1                         0x000
#define BA1_STARTSTOP_CAPTURE                     0x64
#define BA1_CAPTURE_INTERRUPT_ENABLE_REG          0x104
#define BA1_CAPTURE_BUFFER_ADDRESS                0x10c
#define BA1_CAPTURE_SAMPLE_RATE_CORRECTION_REG    0x2c8
#define BA1_CAPTURE_COEFFICIENT_INCREMENT_REG     0x2d8
#define BA1_CAPTURE_DELAY_REG                     0x2e0
#define BA1_CAPTURE_PHASE_INCREMENT_REG           0x2f4
#define BA1_CAPTURE_VOLUME_REG                    0x2f8
#define BA1_CAPTURE_FRAME_GROUP_1_REG             0x134
#define BA1_CAPTURE_FRAME_GROUP_2_REG             0x138
#define BA1_CAPTURE_CONSTANT_REG                  0x13c
#define BA1_CAPTURE_SPB_ADDRESS                   0x340


//****************************************************************************
//
// The following is an array or pairs of DWORDS.  The 1st DWORD is
// a BA1 DWORD offset;  the 2nd DWORD is the corresponding value.
...
#define DEVID_CS4610                            0x6001L
#define DEVID_CS4612                            0x6003L
#define DEVID_CS4615                            0x6004L
