	...
	void * data)
{
	...
	ddprintf("sonic_vibes: midi_interrupt_op() done\n");
}
	...
	void ** cookie)
{
	...
	ddprintf("sonic_vibes: midi_open()\n");
...
midi_close(
	void * cookie)
{
	ddprintf("sonic_vibes: midi_close()\n");
	...
	void * cookie)
{
	int ix;
	status_t f;
	ddprintf("sonic_vibes: midi_free()\n");
	...
	ddprintf("sonic_vibes: midi_free() done\n");
	return f;
}
