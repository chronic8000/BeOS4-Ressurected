...
#define		HFA384x_PDR_LEN_MAX		((UINT16)1024)	/* in bytes, from EK */
...
#define		HFA384x_CHINFORESULT_MAX	((UINT16)8)
...
/* offset from a 32 bit linear address */
...
#define		HFA384x_AUX_MKOFF(n)	((UINT16)((n)&HFA384x_AUX_OFF_MASK))
#define		HFA384x_AUX_MKPAGE(n)	((UINT16)(((n)&HFA384x_AUX_PAGE_MASK)>>7))

/*--- Controller Memory addresses -------------------*/
#define		HFA384x_PDA_BASE	(0x003f0000UL)
#define		HFA384x_PDA_BOGUS_BASE	(0x00390000UL)
...
#define		HFA384x_RID_NICSERIALNUMBER_LEN		((UINT16)0)
#define		HFA384x_RID_NICIDENTITY_LEN		((UINT16)0)
#define		HFA384x_RID_MFISUPRANGE_LEN		((UINT16)0)
#define		HFA384x_RID_CFISUPRANGE_LEN		((UINT16)0)
#define		HFA384x_RID_CHANNELLIST_LEN		((UINT16)0)
#define		HFA384x_RID_REGULATORYDOMAINS_LEN	((UINT16)0)
#define		HFA384x_RID_TEMPTYPE_LEN		((UINT16)0)
#define		HFA384x_RID_CIS_LEN			((UINT16)0)
#define		HFA384x_RID_STAIDENTITY_LEN		((UINT16)0)
#define		HFA384x_RID_STASUPRANGE_LEN		((UINT16)0)
#define		HFA384x_RID_MFIACTRANGES_LEN		((UINT16)0)
#define		HFA384x_RID_CFIACTRANGES2_LEN		((UINT16)0)
...
#define		HFA384x_RID_OWNMACADDRESS_LEN		((UINT16)0)
...
#define		HFA384x_RID_SUPPORTEDDATARATES_LEN	((UINT16)0)
...
#define HFA384x_PDR_PCB_TRACENUM	((UINT16)0x0002)
...
#define		HFA384x_SWSUPPORT0(base)	((UINT)(base) + HFA384x_SWSUPPORT0_OFF)
#define		HFA384x_SWSUPPORT1(base)	((UINT)(base) + HFA384x_SWSUPPORT1_OFF)
#define		HFA384x_SWSUPPORT2(base)	((UINT)(base) + HFA384x_SWSUPPORT2_OFF)
#define		HFA384x_AUXPAGE(base)		((UINT)(base) + HFA384x_AUXPAGE_OFF)
#define		HFA384x_AUXOFFSET(base)		((UINT)(base) + HFA384x_AUXOFFSET_OFF)
#define		HFA384x_AUXDATA(base)		((UINT)(base) + HFA384x_AUXDATA_OFF)
...
#include <ByteOrder.h>
	#define hfa384x2host_16(n)	(B_LENDIAN_TO_HOST_INT16(n))
	#define hfa384x2host_32(n)	(B_LENDIAN_TO_HOST_INT32(n))
	#define host2hfa384x_16(n)	(B_HOST_TO_LENDIAN_INT16(n))
	#define host2hfa384x_32(n)	(B_HOST_TO_LENDIAN_INT32(n))
#else
...
typedef struct hfa384x_ChInfoResultSub
{
	...
	UINT16	bssactive		__WLAN_ATTRIB_PACK__;
	UINT16	pcfactive		__WLAN_ATTRIB_PACK__;
...
#define HFA384x_ASSOCSTATIS_REASSOC	((UINT16)2)
...
typedef struct hfa384x_InfFrame
{
	...
	union {
		hfa384x_HandoverAddr_t	handover	__WLAN_ATTRIB_PACK__;
		hfa384x_CommTallies_t	commtallies	__WLAN_ATTRIB_PACK__;
...
static inline int hfa384x_isgood_pdrcode(UINT16 pdrcode)
{
	...
	case HFA384x_PDR_REFDAC_MEASUREMENTS:
	case HFA384x_PDR_VGDAC_MEASUREMENTS:
	case HFA384x_PDR_LEVEL_COMP_MEASUREMENTS:
	case HFA384x_PDR_MODEM_TRIMDAC_MEASUREMENTS:
	case HFA384x_PDR_MAC_ADDRESS:
	case HFA384x_PDR_MKK_CALLNAME:
	case HFA384x_PDR_REGDOMAIN:
	case HFA384x_PDR_ALLOWED_CHANNEL:
	case HFA384x_PDR_DEFAULT_CHANNEL:
	case HFA384x_PDR_PRIVACY_OPTION:
	case HFA384x_PDR_TEMPTYPE:
	case HFA384x_PDR_REFDAC_SETUP:
	case HFA384x_PDR_VGDAC_SETUP:
	case HFA384x_PDR_LEVEL_COMP_SETUP:
	case HFA384x_PDR_TRIMDAC_SETUP:
