...
void	p80211ind_mlme( wlandevice_t *wlandev, char *skb);
void	p80211ind_sniff( wlandevice_t *wlandev, char *skb);
void	p80211ind_distribution( wlandevice_t *wlandev, char *skb);
