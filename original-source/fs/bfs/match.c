...
int matche_after_star (unsigned char *pattern, unsigned char *text);
int fast_match_after_star (unsigned char *pattern, unsigned char *text);
...
BOOLEAN is_pattern (unsigned char *p)
{
    while ( *p ) {
        switch ( *p++ ) {
            case '?':
...
BOOLEAN is_valid_pattern (unsigned char *p, int *error_type)
{
...
int matche ( unsigned char *p, unsigned char *t )
{
    unsigned char range_start, range_end;  /* start and end in range */
...
int matche_after_star (unsigned char *p, unsigned char *t)
{
...
BOOLEAN match( unsigned char *p, unsigned char *t )
{
    int error_type;
