...
BOOLEAN match (unsigned char *pattern, unsigned char *text);

int     matche(unsigned char *pattern, unsigned char *text);
...
BOOLEAN is_pattern (unsigned char *pattern);
...
BOOLEAN is_valid_pattern (unsigned char *pattern, int *error_type);
