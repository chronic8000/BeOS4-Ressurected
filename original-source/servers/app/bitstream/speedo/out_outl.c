...
*                                                                                    *
*     $Header: //bliss/user/archive/rcs/speedo/out_outl.c,v 33.0 97/03/17 17:46:41 shawn Release $                                                                       *
*                                                                                    *
*     $Log:	out_outl.c,v $
*       Revision 33.0  97/03/17  17:46:41  shawn
*       TDIS Version 6.00
*       
*       Revision 32.1  96/07/02  12:08:12  shawn
*       Changed boolean to btsbool.
*       
*       Revision 32.0  95/02/15  16:36:45  shawn
*       Release
*       
*       Revision 31.2  95/01/12  11:17:16  roberte
*       
*       
*       
*       
...
*       
*       Revision 31.1  95/01/04  16:38:15  roberte
*       Release
*       
*       Revision 30.1  94/12/14  22:30:37  shawn
*       Converted to ANSI 'C'
*       Modified for support by the K&R conversion utility
*       
*       Revision 30.0  94/05/04  09:35:12  roberte
*       Release
*       
*       Revision 29.2  94/04/08  14:38:20  roberte
*       Release
*       
*       Revision 29.0  94/04/08  11:44:16  roberte
*       Release
*       
*       Revision 28.47  93/08/31  09:37:58  roberte
*       Release
*       
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: //bliss/user/archive/rcs/speedo/out_outl.c,v 33.0 97/03/17 17:46:41 shawn Release $";
#endif
...
FUNCTION btsbool sp_init_outline(SPGLOBPTR2 specs_t GLOBALFAR *specsarg)
/*
...
FUNCTION btsbool sp_begin_char_outline(SPGLOBPTR2 point_t Psw, point_t Pmin, point_t Pmax)
/*
...
FUNCTION void sp_begin_sub_char_outline(SPGLOBPTR2 point_t Psw, point_t Pmin, point_t Pmax)
/*
...
FUNCTION void sp_begin_contour_outline(SPGLOBPTR2 point_t P1, btsbool outside)
/*
...
FUNCTION void sp_curve_outline(SPGLOBPTR2 point_t P1, point_t P2, point_t P3, fix15 depth)
/*
...
FUNCTION void sp_line_outline(SPGLOBPTR2 point_t P1)
/*
...
FUNCTION void sp_end_contour_outline(SPGLOBPTR1)
/*
...
FUNCTION void sp_end_sub_char_outline(SPGLOBPTR1)
/*
...
FUNCTION btsbool sp_end_char_outline(SPGLOBPTR1)
/*
