...
*                                                                              *
*     $Header: //bliss/user/archive/rcs/speedo/out_util.c,v 33.0 97/03/17 17:47:07 shawn Release $
*                                                                              *
*     $Log:	out_util.c,v $
 * Revision 33.0  97/03/17  17:47:07  shawn
 * TDIS Version 6.00
 * 
 * Revision 32.2  96/07/02  12:07:39  shawn
 * Changed boolean to btsbool.
 * 
 * Revision 32.1  96/04/11  16:41:41  shawn
 * Moved routines set_bitmap_device() and set_outline_device() from module
 *      set_spcs.c for use by all font technologies.
 * Renamed routines to sp_set_bitmap_device() and sp_set_outline_device() to
 *      avoid unnecessary macro expansion.
 ...
 * 
 * Revision 32.0  95/02/15  16:38:13  shawn
 * Release
 * 
 * Revision 31.2  95/01/12  11:30:24  roberte
 * Updated Copyright header.
 * 
 * Revision 31.1  95/01/04  16:40:03  roberte
 * Release
 * 
 * Revision 30.2  94/12/14  21:58:55  shawn
 * Converted to ANSI 'C'
 * Modified for support by the K&R conversion utility
 * 
 * Revision 30.1  94/12/14  15:28:04  roberte
 * Added PARAMS1 macro where it was missing in set_clip_parameters().
 * 
 * Revision 30.0  94/05/04  09:39:43  roberte
 * Release
 * 
 * Revision 29.2  94/04/08  14:39:13  roberte
 * Release
 * 
 * Revision 29.0  94/04/08  11:45:20  roberte
 * Release
 * 
 * Revision 28.48  93/11/05  09:57:38  roberte
 * Promoted 2 locals that access no_y_lists in SPEEDO_GLOBALS. no_y_lists
 * was promoted as documented in speedo.h audit trail.
 * 
 * Revision 28.47  93/08/31  09:38:32  roberte
 * Release
 * 
 * Revision 28.38  93/04/06  12:31:29  roberte
 * Added || INCL_WHITE for all functions in this module.
 * Thet were previously excluded if the black writer were excluded
 * and only the white writer included.
 * 
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: //bliss/user/archive/rcs/speedo/out_util.c,v 33.0 97/03/17 17:47:07 shawn Release $";
#endif


/*************************** O U T _ U T I L . C *****************************
 *                                                                           *
 * This is a utility module shared by all bitmap output modules              *
 *                                                                           *
 *****************************************************************************/
...
#if INCL_BLACK || INCL_2D || INCL_SCREEN || INCL_WHITE || INCL_QUICK || INCL_GRAY



FUNCTION void sp_init_char_out(SPGLOBPTR2 point_t Psw, point_t Pmin, point_t Pmax)
{
...
FUNCTION void sp_begin_sub_char_out(SPGLOBPTR2 point_t Psw, point_t Pmin, point_t Pmax)
...
FUNCTION void sp_curve_out(SPGLOBPTR2 point_t P1, point_t P2, point_t P3, fix15 depth)
...
FUNCTION void sp_end_contour_out(SPGLOBPTR1)
...
FUNCTION void sp_end_sub_char_out(SPGLOBPTR1)
...
FUNCTION void sp_init_intercepts_out(SPGLOBPTR1)
...
FUNCTION void sp_restart_intercepts_out(SPGLOBPTR1)
...
FUNCTION void sp_set_first_band_out(SPGLOBPTR2 point_t Pmin, point_t Pmax)
{
...
FUNCTION void sp_reduce_band_size_out(SPGLOBPTR1)
{
...
FUNCTION btsbool sp_next_band_out(SPGLOBPTR1)
{
fix15  tmpfix15;
...
/* Access this function using the set_bitmap_device() MACRO */

FUNCTION btsbool sp_set_bitmap_device(SPGLOBPTR2 bitmap_t *bfuncs, ufix16 size)
{
...
#endif  /* INCL_BLACK || INCL_2D || INCL_SCREEN || INCL_WHITE || INCL_QUICK || INCL_GRAY */


#if INCL_OUTLINE && INCL_MULTIDEV

/* Access this function using the set_outline_device() MACRO */

FUNCTION btsbool sp_set_outline_device(SPGLOBPTR2 outline_t *ofuncs, ufix16 size)
{
...
#endif  /* INCL_OUTLINE && INCL_MULTIDEV */



#if INCL_CLIPPING

FUNCTION void set_clip_parameters(SPGLOBPTR1)
{
