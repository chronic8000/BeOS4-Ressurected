...
*                                                                                    *
*     $Header: //bliss/user/archive/rcs/speedo/out_bl2d.c,v 33.0 97/03/17 17:46:24 shawn Release $                                                                       *
*                                                                                    *
*     $Log:	out_bl2d.c,v $
*       Revision 33.0  97/03/17  17:46:24  shawn
*       TDIS Version 6.00
*       
*       Revision 32.5  96/08/06  16:31:52  shawn
*       Cast arguments in call to open_bitmap().
*       
*       Revision 32.4  96/07/02  12:09:35  shawn
*       Changed boolean to btsbool.
*       
*       Revision 32.3  95/11/21  14:41:56  john
*       Bitmap image boundary boundary expanded to include all
*       pixels traversed by scaled outline. This is to ensure
*       that no pixels can be lost by falling  outside the 
*       bitmap image.
*       
*       Revision 32.2  95/11/17  17:55:31  shawn
*       Changed element sp_globals.one_pix to sp_globals.onepix in DEBUG of sp_begin_char_2d()
*       
*       Revision 32.1  95/11/17  10:10:52  shawn
*       Changed "FUNCTION static" declarations to "FUNCTION LOCAL_PROTO"
*       
*       Revision 32.0  95/02/15  16:36:25  shawn
*       Release
*       
*       Revision 31.2  95/01/12  11:16:53  roberte
*       Updated Copyright header.
*       
*       Revision 31.1  95/01/04  16:37:36  roberte
*       Release
*       
*       Revision 30.1  94/12/14  23:01:52  shawn
*       Converted to ANSI 'C'
*       Modified for support by the K&R conversion utility
*       
*       Revision 30.0  94/05/04  09:34:09  roberte
*       Release
*       
*       Revision 29.2  94/04/08  14:37:52  roberte
*       Release
*       
*       Revision 29.0  94/04/08  11:43:53  roberte
*       Release
*       
*       Revision 28.48  94/04/01  15:56:58  roberte
*       Moved some static function prototypes from speedo.h to here.
*       
*       Revision 28.47  93/08/31  09:37:27  roberte
*       Release
*       
...
#ifdef RCSSTATUS
static char rcsid[] = "$Header: //bliss/user/archive/rcs/speedo/out_bl2d.c,v 33.0 97/03/17 17:46:24 shawn Release $";
#endif
...
LOCAL_PROTO void sp_draw_vector_to_2d(SPGLOBPTR2 fix15 x0, fix15 y0, fix15 x1, fix15 y1, band_t GLOBALFAR *band);
LOCAL_PROTO void sp_add_intercept_2d(SPGLOBPTR2 fix15 y, fix15 x);
LOCAL_PROTO void sp_proc_intercepts_2d(SPGLOBPTR1);



#if INCL_2D

FUNCTION btsbool sp_init_2d(SPGLOBPTR2 specs_t GLOBALFAR *specsarg)
/*
...
FUNCTION btsbool sp_begin_char_2d(SPGLOBPTR2 point_t Psw, point_t Pmin, point_t Pmax)
...
FUNCTION void sp_begin_contour_2d(SPGLOBPTR2 point_t P1, btsbool outside)
...
FUNCTION void sp_line_2d(SPGLOBPTR2 point_t P1)
/*
...
FUNCTION LOCAL_PROTO void sp_draw_vector_to_2d(SPGLOBPTR2
										  fix15 x0,
										  fix15 y0,
										  fix15 x1,
										  fix15 y1,
...
FUNCTION btsbool sp_end_char_2d(SPGLOBPTR1)
...
if (sp_globals.first_pass)
    ...
    if (sp_globals.bmap_xmax >= sp_globals.bmap_xmin)
        {
        sp_globals.xmin = sp_globals.bmap_xmin >> sp_globals.pixshift;
        sp_globals.xmax = (sp_globals.bmap_xmax + sp_globals.onepix - 1) >> sp_globals.pixshift;
        }
    else
        {
...
#endif
        sp_globals.ymax = (sp_globals.bmap_ymax + sp_globals.onepix - 1) >> sp_globals.pixshift;

#if INCL_CLIPPING
        if ( !(sp_globals.specs.flags & CLIP_BOTTOM))
#endif
        sp_globals.ymin = sp_globals.bmap_ymin >> sp_globals.pixshift;
        }
    else
        {
...
FUNCTION LOCAL_PROTO void sp_add_intercept_2d(SPGLOBPTR2 fix15 y, fix15 x)
...
FUNCTION LOCAL_PROTO  void sp_proc_intercepts_2d(SPGLOBPTR1)
