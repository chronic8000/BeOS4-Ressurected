 ...
 * $Header: //bliss/user/archive/rcs/type1/tr_fdata.h,v 33.0 97/03/17 17:59:37 shawn Release $
 *
 * $Log:	tr_fdata.h,v $
 * Revision 33.0  97/03/17  17:59:37  shawn
 * TDIS Version 6.00
 * 
 * Revision 32.2  96/07/02  12:54:50  shawn
 * Changed boolean to btsbool.
 * 
 * Revision 32.1  96/06/05  15:21:17  shawn
 * Added support for faster font loader.
 * Fixed RESTRICTED_ENVIRON problem.
 * 
...
#define FULLNAMESIZE    63
#define FONTNAMESIZE    63
#define FAMILYNAMESIZE  63

#define font_data_BUF_SIZE      2048
...
typedef struct
	...
	char            font_name[FONTNAMESIZE + 1];
        char            family_name[FAMILYNAMESIZE +1];
	fix31           paint_type;
        btsbool         isFixedPitch;
        fix15           UnderlinePosition;
        fix15           UnderlineThickness;
	fbbox_t         font_bbox;
	...
	fix15           no_charstrings;		/* Number of characterstrings read */
        fix15           no_charstrings_loaded;  /* Number of characterstrings loaded */
	...
	ufix16          font_file_type;
        ...
        ufix8          *buf;
        ufix8          *buf_end;
        ufix8           buf_start[font_data_BUF_SIZE];
        ufix16          buf_size;
        fix31           offset;
...
/* PRR modif begin */
#if RESTRICTED_ENVIRON
GLOBAL_PROTO btsbool WDECL tr_load_font(PROTO_DECL2 ufix8 STACKFAR *font_ptr, ufix16 buffer_size, void *fc_ctxt);
#else
GLOBAL_PROTO btsbool tr_load_font(PROTO_DECL2 font_data **font_ptr, void *fc_ctxt);
#endif
/* PRR modif end */
