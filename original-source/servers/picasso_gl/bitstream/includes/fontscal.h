...
*                                                                                    *
*     $Header: //bliss/user/archive/rcs/true_type/fontscal.h,v 14.0 97/03/17 17:53:41 shawn Release $                                                                       *
*                                                                                    *
*     $Log:	fontscal.h,v $
 * Revision 14.0  97/03/17  17:53:41  shawn
 * TDIS Version 6.00
 * 
 * Revision 10.1  96/07/02  13:48:22  shawn
...
typedef struct {
	...
	btsbool  begin_contour;	/* MOVE flag */
...
#if INCL_VERTICAL
GLOBAL_PROTO int32 fs_NewGlyph(fs_GlyphInputType *inputPtr, fs_GlyphInfoType *outputPtr, btsbool vertical);
#else
