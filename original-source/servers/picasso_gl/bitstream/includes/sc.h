...
*                                                                             *
*     $Header: //bliss/user/archive/rcs/true_type/sc.h,v 14.0 97/03/17 17:54:38 shawn Release $                                 
*                                                                              
*     $Log:	sc.h,v $
 * Revision 14.0  97/03/17  17:54:38  shawn
 * TDIS Version 6.00
 * 
 * Revision 10.1  97/01/14  17:39:30  shawn
 * Added Prototype statements for ns_ProcOutlSetUp() and ns_ProcOutl().
 * 
 * Revision 10.0  95/02/15  16:25:06  roberte
 * Release
 * 
 * Revision 9.1  95/01/04  16:37:27  roberte
 * Release
 * 
 * Revision 8.1  95/01/03  13:22:41  shawn
 * Converted to ANSI 'C'
 * Modified for support by the K&R conversion utility
 * 
 * Revision 8.0  94/05/04  09:32:28  roberte
 * Release
 * 
 * Revision 7.0  94/04/08  11:58:58  roberte
 * Release
 * 
 * Revision 6.92  94/04/01  16:06:25  roberte
 * Employed new PROTOTYPE macro for all function prototypes.
 * 
 * Revision 6.91  93/08/30  14:52:45  roberte
 * Release
 * 
...
GLOBAL_PROTO int sc_ScanChar(sc_CharDataType *glyphPtr, sc_GlobalData *scPtr, sc_BitMapData *bbox,
 ...
 */
GLOBAL_PROTO int sc_FindExtrema(sc_CharDataType *glyphPtr, sc_BitMapData *bbox);
